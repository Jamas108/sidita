            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="Nama Kosong" id="nama_penilai" name="nama_penilai"
                        value="<?= esc($user['nama_awal_penyedia']); ?> <?= esc($user['nama_penyedia']); ?> <?= esc($user['nama_akhir_penyedia']); ?>" readonly>
                </div>
                <div class="form-group col-md-4">
                    <input style="background-color: #385dcf; color: white" type="text" class="form-control"
                        placeholder="" id="nama" name="nama" value="Jabatan" disabled>
                </div>
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="Jabatan Kosong" id="jabatan" name="jabatan"
                        value="<?= esc($user['jabatan']); ?>" readonly>
                </div>
                <div class="form-group col-md-4">
                    <input style="background-color: #385dcf; color: white" type="text" class="form-control"
                        placeholder="" id="nama" name="nama" value="NIP" disabled>
                </div>
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="NIP Kosong" id="jabatan" name="jabatan"
                ...
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="Email Kosong" id="email_user" name="email_user"
                ...
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="Role Kosong" id="role_user" name="role_user"
                ...
                <div class="form-group col-md-8">
                    <input type="text" class="form-control"
                        placeholder="Tanggal Kosong" id="created_at_user" name="created_at_user"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="<?= base_url('operatorupdatepassword') ?>">
