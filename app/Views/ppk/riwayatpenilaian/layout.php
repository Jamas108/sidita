    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('ppkdashboard'); ?>">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('managereviewpekerjaan'); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Review Pekerjaan</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manageriwayatpenilaian'); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Riwayat Penilaian</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('managedptppk'); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Kelola DPT</span></a>
            </li>
        ...
        <script src="<?= base_url('lib/swiper/swiper-bundle.min.js') ?>"></script>
