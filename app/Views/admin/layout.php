...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('adminmanagepekerjaan'); ?>">
                    <i class="fas fa-fw fa-scroll"></i>
                    <span>Kelola Pekerjaan</span></a>
            </li>
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?= base_url('managebroadcast'); ?>">
                    <i class="fas fa-fw fa-bullhorn"></i>
                    <span>Kelola Broadcast</span></a>
            </li> -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('profilsuperadmin'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div style="margin-left: -80px;" class="dropdown-menu dropdown-menu-right shadow" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('profilsuperadmin'); ?>">
