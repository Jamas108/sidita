...
<head>
  ...
  <link href="<?= base_url('https://unpkg.com/leaflet/dist/leaflet.css') ?>" rel="stylesheet">
  <link href="<?= base_url('https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.css') ?>" rel="stylesheet">
  <link href="https://api.mapbox.com/mapbox-gl-js/v2.9.1/mapbox-gl.css" rel="stylesheet" />
  <script src="https://api.mapbox.com/mapbox-gl-js/v2.9.1/mapbox-gl.js"></script>
  <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dxist/leaflet.css" />
...
<body class="index-page">
  ...
  <!-- <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright text-center ">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">SIDITA</strong> <span>All Rights Reserved</span></p>
      </div>
  ...
  <!-- Tambahkan dependensi CSS dan JavaScript Bootstrap di dalam tag <head> -->
