...
class OperatorManagePekerjaanController extends ResourceController
{
    public function index()
    {
        ...
        return view('operator/managepekerjaan/index', ['dataPekerkjaan' => $dataPekerkjaan]);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('managepekerjaan')->with('success', 'Data pekerjaan berhasil disimpan.');
    }
    public function DetailPekerjaan($id)
    {
        ...
        return view('operator/managepekerjaan/show', ['detailPekerjaan' => $detailPekerjaan]);
    }
    ...
    public function updatePekerjaan($id)
    {
        ...
        return redirect()->to('managepekerjaan')->with('success', 'Data pekerjaan berhasil diperbarui.');
    }
    ...
    public function updateStatusPekerjaan($id)
    {
        ...
        if (!in_array($status, ['berjalan', 'selesai'])) {
            return redirect()->to('/managepekerjaan')->with('error', 'Status tidak valid.');
        }

        $pekerjaanModel = new PekerjaanModel();
        $pekerjaanModel->update($id, ['status_pekerjaan' => $status]);

        return redirect()->to('managepekerjaan')->with('success', 'Status Pekerjaan berhasil diperbarui.');
    }
    ...
    public function deletePekerjaan($id)
    {
        ...
        // Redirect with success message
        return redirect()->to('managepekerjaan')->with('success', 'Data pekerjaan berhasil dihapus.');
    }
}
